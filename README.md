...
It is important to thoroughly consult these files to learn how to run the battery and comprehend all its features. They should be consulted in the following order:
