...
It is important to consult these files thoroughly to learn how to run the battery and comprehend all its features. They should be consulted in the following order:
