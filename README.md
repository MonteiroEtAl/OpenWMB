...
- The OpenWMB is available in Portuguese and English — however, we only assessed the psychometric properties of the former version. The raw data collected for this study and the imputed databases used to estimate the psychometric properties of the Portuguese version are stored in the files named "Raw_Data_Validation_PT_version.xlsx" and "Imputed_Databases_Validation_PT_version.xlsx", respectively. The file "Code_Statistical_Analysis.R" contains the code that was used to compute all the analyses that were carried out to assess the psychometric properties of the Portuguese version of the OpenWMB. If you intend to replicate these analyses, please read the comments provided in the first eight lines of the R file very carefully.  
