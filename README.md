...
## Compatibility
The WM battery is compatible with Microsoft Windows (Vista or above) and Apple Mac OS (the battery was tested in macOS Ventura, versão 13.2.1). 
...
## Compatibilidade
A bateria é compatível com o Microsoft Windows (Vista ou versões mais recentes) e Apple Mac OS (a bateria foi testada no macOS Ventura, version 13.2.1).
