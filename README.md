...
Esta bateria contém sete tarefas de memória de trabalho que podem ser agregadas em três classes: Complex Spans (Reading Span, Operation Span e Symmetry Span); Tarefas de Atualização (Numerical Updating Task e Dual N-back Task); e Tarefas de Coordenação (Binding Task e Multimodal Span).
