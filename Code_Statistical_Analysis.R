...
#Replace the string 'XXXXX' bellow with the path of the directory in which you stored the R script and the Excel files with the databases. 
...
##Example setwd("C:\\Users\\public\\OneDrive\\Desktop")
setwd("XXXXX")
...
##The table presented in the article by Monteiro et al. (2024) was sorted manually.
